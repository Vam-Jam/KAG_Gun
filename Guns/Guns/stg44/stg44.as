...
const uint8 FIRE_INTERVAL = 6; //Used 
const uint8 CLIP        = 32; //Used
const uint8 TOTAL       = 128; //Used
...
const int   G_RECOILT= 4; //How long should recoil last, 10 is default, 30 = 1 second (like ticks)
const int   G_BACK_T = 3; //Should we recoil the arm back time? (aim goes up, then back down with this, if > 0, how long should it last)
...
const string FIRE_SOUND    = "AutoFire.ogg"; //Used
