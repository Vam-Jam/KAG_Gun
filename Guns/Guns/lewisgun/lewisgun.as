...
const uint8 FIRE_INTERVAL    = 1; //Used maybe?
const float BULLET_DAMAGE    = 0.7;   //Unused
const uint8 PROJECTILE_SPEED = 27;  //Unused
const float TIME_TILL_DIE    = 1.3; //Unused
...
//NEW BULLET PROPS
const int8  B_SPREAD = 30; //the higher the value, the more 'uncontrolable' bullets get
