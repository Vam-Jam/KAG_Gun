...
const uint8 FIRE_INTERVAL = 40; //Used 
const uint8 CLIP        = 5; //Used
const uint8 TOTAL       = 40; //Used
...
const int   G_RECOIL= -40; //0 is default, adds recoil aiming up
...
const int   G_RECOILT= 7; //How long should recoil last, 10 is default, 30 = 1 second (like ticks)
const int   G_BACK_T = 0; //Should we recoil the arm back time? (aim goes up, then back down with this, if > 0, how long should it last)
...
const string FIRE_SOUND    = "heavyRifleFire.ogg"; //Used
